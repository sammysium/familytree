...
urlpatterns = [
    ...
    url(r'^person/(?P<person_id>\d+)/photo/$', views.add_person_photo, name='photo'),
    ...
    url(r'^person/(?P<person_id>\d+)/ancestors/treechart/$', views.family_tree_chart, name='tree_chart'),
